...
export const Section3 = () => {
    ...
    return (
        <section className="bg-white text-white flex-col" id="section3">
            {/*Arka Plan*/}
            ...
            <div className="flex items-center h-[15vh] justify-center">
                ...
                <label className="text-center text-white bg-[#06141B] shadow-2xl font-extrabold text-[3vh] sm:text-[3.5vh] lg:text-[4.3vh] h-fit xl:mb-5 px-2" >{`My Writings and Poems`}</label>
