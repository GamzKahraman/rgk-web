...
export const Section2 = () => {
    const labelClass =
        "text-justify my-1 mx-1 text-[1.5vh] sm:text-[2vh] md::w-[40vw] xl:text-[2.5vh] bg-[#AEF359] p-2 text-center"

    return (
        <section className="bg-white text-white flex-col" id="section2">
            {/* Arka Plan */}
            <div className="w-full h-[100px] bg-[#AEF359]"></div>
            <div className="w-full h-[90vh] flex flex-col  justify-start sm:justify-center mx-4">
                <div className="flex items-center h-[15vh] justify-center ">
                    ...
                    <label className="text-center text-white bg-[#AEF359] shadow-2xl font-extrabold text-[3vh] sm:text-[3.5vh] lg:text-[4.3vh] h-fit xl:mb-5 px-2">{`About Me`}</label>
                </div>
